...
export class AppComponent {
  ...
  downloadFileSystem() {
    ...
    console.log(this.name+this.lastext1+this.exten)
    this.webSocketService.downloadFileSystem(this.name, this.exten, this.lastext1)
      .subscribe(
        response => {
          ...
          //console.log(ext2);
          this.saveFile(response.body, this.exten, filename);
